        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (response.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Logged successfuly');
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', _context.t0.reponse.data);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2luZ2dzdGFyazEiLCJhIjoiY2t4YWM3d2drMG51ODJ1bXZ6eDI0OXdqeSJ9.2-SSbG7OxKVzg-2F1ZEmbg';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log(data);
            _context.prev = 1;
            url = type === 'password' ? 'http://localhost:3000/api/v1/users/changePassword' : "http://localhost:3000/api/v1/users/changeMe";
            _context.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 5:
            ...
            if (res.data.status == 'success') {
              (0, _alert.showAlert)('success', "".concat(type, " updated successfuly"));
            }
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](1);
            (0, _alert.showAlert)('error', 'there was a problem updating your data');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51IKR1TI6EqHGiI1ossxNbl3JsvYZZFfJMzwjQXG9rxLi0tfnum1oA4lKgHOh5JpyDUuMhdrQXv9l383h285oKxwv00laF0fup3');
            _context.next = 4;
